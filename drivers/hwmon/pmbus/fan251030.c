...
static struct pmbus_driver_info fan251030_info = {
	...
	.func[0] = PMBUS_HAVE_VIN | PMBUS_HAVE_VOUT | PMBUS_HAVE_TEMP |
		   PMBUS_HAVE_TEMP2 | PMBUS_HAVE_IIN | PMBUS_HAVE_IOUT |
...
static int fan251030_probe(struct i2c_client *client)
{
	...
	info = devm_kmemdup(&client->dev, &fan251030_info, sizeof(*info),
			    GFP_KERNEL);
	if (!info)
		return -ENOMEM;
...
static const struct i2c_device_id fan251030_id[] = { { "fan251015", fan251015 },
						     { "fan251030", fan251030 },
						     {} };

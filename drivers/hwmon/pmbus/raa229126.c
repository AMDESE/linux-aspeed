...
enum chip { raa229126, raa229639, raa229641 };
...
static int raa229126_probe(struct i2c_client *client)
{
	...
	info = devm_kmemdup(&client->dev, &raa229126_info, sizeof(*info),
			    GFP_KERNEL);
	if (!info)
		return -ENOMEM;
...
static const struct i2c_device_id raa229126_id[] = { { "raa229126", raa229126 },
						     { "raa229639", raa229639 },
						     { "raa229641", raa229641 },
						     {} };
